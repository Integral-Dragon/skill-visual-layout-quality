...
This repo now keeps detailed references in `references/`.

- [references/incident-patterns.md](references/incident-patterns.md)
- [references/research-notes.md](references/research-notes.md)
- [references/validation-round.md](references/validation-round.md)
